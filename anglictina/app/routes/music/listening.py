"""Poslechové lekce (blueprint `listening_bp`).

Lekce ze static/listening/listening_lesson.json; výsledky do statistik
(lis_cor/lis_wr), XP a streaku.
"""
...
DATA_FILE = os.path.join(APP_DIR, 'static', 'listening', 'listening_lesson.json')
