"""Podcasty s přepisem (blueprint `podcast_bp`).

MP3 + LRC soubory ze static/podcast/{mp3,lrc}; poslech a odpovědi jdou
do statistik (pds_cor/pds_wr), XP a streaku.
"""
...
STATIC_PODCAST_DIR = Path(APP_DIR) / 'static' / 'podcast'
