"""Připomínky: e-maily + push notifikace neaktivním uživatelům.

send_daily_reminders() periodicky volá worker (worker_main.py). Modul hlídá
denní limity (MAX_EMAILS_PER_DAY / MAX_PUSHES_PER_DAY), povolené hodiny
odeslání a throttling kvůli rate limitům Resendu. Blueprint `reminders`
navíc obsluhuje unsubscribe odkazy a ruční scan.
"""
