...
Obsahuje (vše pod blueprintem `auth`):
  - registraci, login/logout, zapomenuté heslo (ověřovací kód e-mailem)
  - přihlášení přes Google OAuth
  - nastavení profilu (/settings, profilovka, téma, úroveň angličtiny)
  - učitelskou sekci (skupiny studentů, úkoly/assignments)
  - odesílání e-mailů přes Resend API (send_email / send_email_html —
    používá i reminders.py)
  - migraci schématu users pro OAuth (ensure_users_table, volá main.py)
"""
...
from xp import get_all_achievements, get_top_users, get_user_achievements, get_user_xp_and_level

# ===========================================================================
# E-mail: rate limiter + odesílání přes Resend
# ===========================================================================
...
def continue_lesson():
    ...
    # Reset session proměnných pro novou lekci
...
# ===========================================================================
# Migrace schématu users (volá main.py při startu) + dev login
# ===========================================================================
