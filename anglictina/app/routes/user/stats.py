"""Stránka se statistikami uživatele (blueprint `user_stats`).

Pozn.: ensure_user_stats_exists() je zjednodušená kopie stejné funkce ze
services/user_stats.py — kandidát na sjednocení.
"""
