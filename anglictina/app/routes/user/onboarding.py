"""Onboarding flow pro nové uživatele (blueprint `onboarding_bp`).

Krokový průvodce (STEPS) po registraci/prvním vstupu; po dokončení nastaví
users.has_seen_onboarding. Guest uživatele na / přesměrovává main.py na /welcome.
"""
