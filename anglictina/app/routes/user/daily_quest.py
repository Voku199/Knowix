"""Denní úkoly (blueprint `daily`).

Definice questů ve static/daily_quest.json, denní výběr per-user
(deterministicky hashem user_id+datum), progress v tabulce user_daily_quests.
get_daily_quests_for_user() používá context processor v main.py.
"""
...
def _json_path():
    # static leží v kořeni app/ (viz _paths.APP_DIR)
