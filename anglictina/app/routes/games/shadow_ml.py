"""Shadow speaking — opakování vět nahlas (blueprint `shadow_ml`).

Věty podle úrovně ze static/shadow_ml/sentences.json (s vestavěným
fallbackem). Výsledky jdou do statistik (shw_cor/shw_mb/shw_wr), XP a streaku.
"""
...
def load_sentences():
    ...
    try:
        ...
        json_path = os.path.join(APP_DIR, 'static', 'shadow_ml', 'sentences.json')
