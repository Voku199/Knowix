"""Wordle (blueprint `wordle`).

Denní hádání slova (stejné pro všechny — klíč z pořadového čísla dne).
Slova ze static/wordle/wordle.json, průběh se ukládá do user_stats
