"""Slovní fotbal (blueprint `slovni_fotbal`).

Hra proti AI: hráč a AI se střídají ve slovech, kde nové slovo začíná posledním
písmenem předchozího. Validace slov + tahy AI přes aimlapi gateway, použitá
slova se cachují do cache/slovni_fotbal_cache.json. Endpoint set_timer má
výjimku z CSRF (registruje se do security_ext.EXEMPT_ENDPOINTS).
"""
...
CACHE_PATH = os.path.abspath(os.path.join(APP_DIR, "cache"))
