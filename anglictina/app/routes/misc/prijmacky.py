"""Přijímačky z angličtiny (blueprint `prijmacky`).

Testy podle úrovní (LEVELS) z JSON souborů ve static/prijmacky.
"""
...
def _static_prijmacky_dir() -> str:
    # JSONy držíme u aplikace ve static/prijmacky (kořen app/, viz _paths.APP_DIR)
    from _paths import APP_DIR
    return os.path.join(APP_DIR, 'static', 'prijmacky')
