"""Present perfect — chatové lekce (blueprint `chat_bp`).

Lekce ze static/gram/present_perfect/chat_lessons.json formou konverzace;
odpovědi se vyhodnocují fuzzy porovnáním (SequenceMatcher). Výsledky jdou
do statistik (pp_correct/pp_maybe/pp_wrong), XP a streaku.
"""
