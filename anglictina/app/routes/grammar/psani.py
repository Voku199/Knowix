"""Psaní — volné texty v angličtině (blueprint `psani`).

Uživatel píše anglický text; kontrola jazyka přes langdetect, vyhodnocení
kvality přes aimlapi gateway (AI_API_KEY). Počet slov jde do statistik
(total_psani_words), přidává XP a streak.
"""
