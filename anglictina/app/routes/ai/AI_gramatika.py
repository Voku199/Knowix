"""AI gramatika (blueprint `ai_gramatika_bp`).

Generuje gramatická cvičení přes aimlapi gateway (AI_API_KEY) pro témata
z GRAMMAR_TOPICS; vygenerované úlohy se cachují do
cache/ai_gramatika_items_cache.json (TTL 7 dní). Překlady přes DeepL.
"""
...
_CACHE_FILE = os.path.join(APP_DIR, 'cache', 'ai_gramatika_items_cache.json')
