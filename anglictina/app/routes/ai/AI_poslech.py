"""AI Poslech — mluvený AI chat (blueprint `ai_poslech`).

Konverzace s AI s hlasovým výstupem: odpovědi generuje aimlapi gateway
(AI_API_KEY), text-to-speech zajišťuje gTTS (pokud je dostupná). Historie
konverzace se drží v session (posledních HISTORY_LIMIT zpráv). Po ~2 minutách
mluvení se započítá streak.
"""
