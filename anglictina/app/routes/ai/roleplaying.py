"""Roleplaying — konverzační scénáře (blueprint `roleplaying`).

Hraní rolí podle scénářů ze static/speaking/roleplaying (JSON); odpovědi
uživatele vyhodnocuje AI přes aimlapi gateway. Výsledky se počítají do
statistik (roleplaying_cr/mb/wr), XP a streaku.
"""
...
SCENARIOS_DIR = os.path.join(APP_DIR, 'static/speaking/roleplaying')
