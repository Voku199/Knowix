"""Souborová cache pro texty písní a překlady (složka cache/ v kořeni app/).

Lyrics: jeden JSON na píseň. Překlady: jeden JSON na cílový jazyk
(mapa původní text -> překlad). Zápisy chráněné zámky kvůli vláknům.
"""
