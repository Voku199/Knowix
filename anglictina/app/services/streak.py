"""Streak systém — počítání denní série uživatele.

Veřejné API: update_user_streak(user_id) po dokončení lekce,
get_user_streak(user_id) pro zobrazení. Logika: konsekutivní den streak
prodlouží, vynechaný den zkusí spotřebovat "freeze" (tabulka user_freeze),
jinak se streak resetuje na 1.
"""
